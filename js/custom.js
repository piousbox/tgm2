...
$('.btn-left').on('click', function () {
  if (collapseState === 'left') {
    /* nothing */
  } else if (collapseState === 'center') {
    collapseState = 'left'
    $('.folder-both').addClass('folder-collapse-left')
  } else if (collapseState === 'right') {
    collapseState = 'center'
    $('.folder-both').removeClass('folder-collapse-right')
  }
})
$('.btn-right').on('click', function () {
  if (collapseState === 'right') {
    ...
    collapseState = 'right'
    $('.folder-both').addClass('folder-collapse-right')
